...
\noindent This process applied to the matrix $\left[\begin{smallmatrix}a & c \\ b & d \end{smallmatrix}\right]=\left[\begin{smallmatrix}2 & 3 \\ 4 & 1 \end{smallmatrix}\right]$, is shown in Figure~\ref{fig:undo_matrix} (some not to scale).
