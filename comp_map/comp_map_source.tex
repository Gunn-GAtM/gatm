...
\item \begin{enumerate}
\item Find the height of the parallelogram in Figure~\ref{parallelogram_generic} in terms of $b$ and a trig function in terms of $\varphi$.
...
\item The difference of the products of the two diagonals of a $2\times 2$ matrix is called the determinant of the matrix, written $\det M$. What does it measure?
...
$$\twomat{\frac{1}{a}}{0}{0}{1}\twomat{a}{c}{b}{d} = \twomat{1}{\frac{c}{a}}{\frac{b}{a}}{\frac{d}{a}}.$$
