...
\end{tabular}
\footnotetext{To construct the Cantor set, begin with the unit segment $[0,1]$ and delete the middle third, resulting in $[0,1/3] \cup [2/3, 1]$. Infinitely repeat this process on every subinterval, so that the total length of the set goes to $0$.}
