...
\item Which subgroups of $C_6$ and $D_3$ are isomorphic?
\end{enumerate}
...
If an infinite group was somehow ``bigger'' than the other, they wouldn't be isomorphic.\footnote{Can you think of an example of two groups with the same ``size'' that also aren't isomorphic?} This raises the question: are all infinities equally big?
