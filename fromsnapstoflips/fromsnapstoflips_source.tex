...
Naturally, these six positions form another group: the \textbf{dihedral group} of order $3$, $D_3$. Splitting up ``dihedral'' into ``di-'' and ``-hedral,'' we see it means ``two faces,'' just like the two faces of our paper triangle. Let's study the properties of this group.
