...
In our example, to find the top left number $a_{11}$, we'd do $\langle 1,2,3\rangle \cdot \langle 7,9,11\rangle$. In general, to find $(XY)_{ij}$, we find the dot product of the $i$th \textbf{row vector} of $X$ and $j$th \textbf{column vector} of $Y$.
