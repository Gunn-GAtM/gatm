...
\begin{enumerate}
\item The three-post snap group can be represented by a set of graphs, each with three nodes. The posts are the towns and the elastic bands are the roads. For example, \label{prob:adjacency_matrices_map_subgroup}
