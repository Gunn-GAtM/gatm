...
\noindent The maximum such period (i.e. $\max P_n$) is actually known as Landau's function, $g(n)$. It turns out that $\operatorname{ln} g(n) \sim \sqrt{n\operatorname{ln} n}$ as $n\to\infty$, a result proved in 1902 by Edmund Landau. Therefore, $g(n)$ is sub-exponential but grows faster than any polynomial.
