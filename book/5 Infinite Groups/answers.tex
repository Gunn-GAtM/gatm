...
This might be counterintuitive, that a set with "length" $0$ is still bigger than all the rational numbers on the great big number line. The Wikipedia article on the Cantor set may guide you further!
