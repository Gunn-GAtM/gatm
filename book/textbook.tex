...
% Include the cover pdf, which will be built into log/cover.pdf first
\includepdf[noautoscale=true,pages=-,width=\paperwidth]{textbook_cover.pdf}

\setlength{\parskip}{1em}
\subfile{credits/credits.tex} % Credits file
