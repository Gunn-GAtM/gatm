...
Write valid group tables using exactly $1$, $2$, and $3$ elements from the snap group. \label{prob:group_definition_end}
...
\item Notice that $E\snap E\snap E=I$. (See Figure~\ref{fig:eper3}.) This means that $E$ has a period of $3$ when acting upon itself. Which elements have a period of \begin{multicols}{3}
\begin{enumerate}
\item 1?
\item 2?
\item 3?
