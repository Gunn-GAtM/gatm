...
\begin{figure}[h]
	...
	\begin{center}
		\begin{minipage}[t]{0.55\textwidth}
			\caption[A matrix acts on two eigenvectors]{The matrix $\left[\begin{array}3 & 24 \\ 4 & 7\end{array}\right]$ acts on two eigenvectors.}
...
\end{enumerate}
\end{multicols}
\item Fill in the blanks: The image of an eigenvector will stay the same \underline{\phantom{egg}} through the \underline{\phantom{egg}} when acted on by any power of the transformation \underline{\phantom{egg}} for which it is an eigenvector. Therefore, the image of the eigenvector is simply the \underline{\phantom{egg}} of the \underline{\phantom{egg}} itself by its corresponding \underline{\phantom{egg}}.
