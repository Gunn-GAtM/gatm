...
Now, consider ``\textbf{clock arithmetic},'' which deals with integers $0$ through $11$ as hours on the clock: $0$ replaces $12$ for mathematical convenience. Numbers ``wrap'' around as the remainder of 12, so $13\to 1$ and $25\to 1$ for instance. We use the congruency sign $\equiv$ to denote clock arithmetic instead of $=$.
